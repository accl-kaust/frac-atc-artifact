...
.m_axi_awaddr(m_axi_reconf_awaddr),
.m_axi_awburst(m_axi_reconf_awburst),
.m_axi_awid(m_axi_reconf_awid),
.m_axi_awlen(m_axi_reconf_awlen),
.m_axi_awsize(m_axi_reconf_awsize),
.m_axi_awvalid(m_axi_reconf_awvalid),
.m_axi_awready(m_axi_reconf_awready),
.m_axi_wdata(m_axi_reconf_wdata),
.m_axi_wstrb(m_axi_reconf_wstrb),
.m_axi_wdata_parity(m_axi_reconf_wdata_parity),
.m_axi_wlast(m_axi_reconf_wlast),
.m_axi_wvalid(m_axi_reconf_wvalid),
.m_axi_wready(m_axi_reconf_wready),
.m_axi_bid(m_axi_reconf_bid),
.m_axi_bresp(m_axi_reconf_bresp),
.m_axi_bvalid(m_axi_reconf_bvalid),
.m_axi_bready(m_axi_reconf_bready),
.m_axi_araddr(m_axi_reconf_araddr),
.m_axi_arburst(m_axi_reconf_arburst),
.m_axi_arid(m_axi_reconf_arid),
.m_axi_arlen(m_axi_reconf_arlen),
.m_axi_arsize(m_axi_reconf_arsize),
.m_axi_arvalid(m_axi_reconf_arvalid),
.m_axi_arready(m_axi_reconf_arready),
.m_axi_rid(m_axi_reconf_rid),
.m_axi_rdata(m_axi_reconf_rdata),
.m_axi_rdata_parity(m_axi_reconf_rdata_parity),
.m_axi_rresp(m_axi_reconf_rresp),
.m_axi_rlast(m_axi_reconf_rlast),
.m_axi_rvalid(m_axi_reconf_rvalid),
.m_axi_rready(m_axi_reconf_rready)
