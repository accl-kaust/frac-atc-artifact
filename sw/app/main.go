...
func main() {
	...
	doIdentify := flag.Bool("identify", false, "probe slots 0..3 and report which accelerator answers in each")
	identifySlots := flag.String("identify-slots", "0,1,2,3", "slots to probe in -identify mode")
